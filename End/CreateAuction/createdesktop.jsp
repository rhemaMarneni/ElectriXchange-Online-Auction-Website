...
<body>
	...
	<h1 style="background-color: white; font-family: 'Trebuchet MS', sans-serif;">Specify Parameters for your Desktop listing:</h1>
	...
	<div class="container" style="text-align: left;">
		<form action="addDesktop.jsp" method="post">
			<!-- NAME -->
			<div class="itemrow">
			...
			<!-- CHARGER -->
			<div class="itemrow">
				<div class="itemcolumn1"><label>Other parts Included? (mention in notes section):</label></div>
				<div class="itemcolumn2">
