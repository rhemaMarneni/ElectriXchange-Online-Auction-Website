...
<body>
	...
	<div class="container" style="text-align: left;">
		<%
			...
			if(endDate.equals("")){
				out.println("Auction End Date Invalid. Try Again<br><br><a href='createphone.jsp' class='button'>Try Again</a>");
			}
			else{
				...
				if(minPrice.equals("0") || minPrice.equals("")){
					out.println("The minimum price must be above $1<br><br><a href='createphone.jsp' class='button'>Try Again</a>");
				}
				else if(!validDate){
					out.println("Auction End Date Invalid. Try Again<br><br><a href='createphone.jsp' class='button'>Try Again</a>");
				}
					...
					String query = "select * from items natural left join phones where name = ? and item_condition = ? and manufacturing_location = ? and brand = ? and color = ? and "+
					"ram = ? and os = ? and storagetype = ? and charger = ? and dimensions = ?";
					...
					if(rs.next()){
						...
						String addPhoneQuery = "insert into phones values(?, ?, ?)";
						PreparedStatement addPhoneStatement = con.prepareStatement(addPhoneQuery);
						addPhoneStatement.setInt(1, newItemID);
						addPhoneStatement.setString(2, charger);
						addPhoneStatement.setString(3, dim);	
