...
<body>
	...
	<h1 style="background-color: white; font-family: 'Trebuchet MS', sans-serif;">Specify Parameters for your Phone listing:</h1>
	...
	<div class="container" style="text-align: left;">
		<form action="addPhone.jsp" method="post">
			...
			<!-- CHARGER -->
			<div class="itemrow">
				<div class="itemcolumn1"><label>Charger (select):</label></div>
				<div class="itemcolumn2">
